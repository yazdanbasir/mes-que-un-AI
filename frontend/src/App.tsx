...
export default function App() {
  return (
    <div className="min-h-screen bg-anthropic-warm-gray flex items-center justify-center p-4 md:p-8 lg:p-12">
      <div className="w-full max-w-7xl h-[90vh] bg-anthropic-white rounded-[32px] overflow-hidden flex shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-anthropic-tan/20">
        <Sidebar />
